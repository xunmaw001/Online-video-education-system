    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="章节目录" prop="zhangjiemulu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="章节目录"
                  v-model="ruleForm.zhangjiemulu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zhangjiemulu" label="章节目录" prop="zhangjiemulu">
                    <span>{{ruleForm.zhangjiemulu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.kechengxiangqing = this.ruleForm.kechengxiangqing.replace(reg,'../../../ssm7nmw0/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
