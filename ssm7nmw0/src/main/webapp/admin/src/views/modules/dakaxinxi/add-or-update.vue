<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="观看分钟" prop="guankanfenzhong">
          <el-input v-model="ruleForm.guankanfenzhong" 
              placeholder="观看分钟" clearable  :readonly="ro.guankanfenzhong"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="观看分钟" prop="guankanfenzhong">
              <el-input v-model="ruleForm.guankanfenzhong" 
                placeholder="观看分钟" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  data() {
	...
	userid : false,
      ...
      rules: {
          ...
          guankanfenzhong: [
                { required: true, message: '观看分钟不能为空', trigger: 'blur' },
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.dakaneirong = true;
          ...
          if(o=='guankanfenzhong'){
            this.ruleForm.guankanfenzhong = obj[o];
	    this.ro.guankanfenzhong = true;
            continue;
          }
          if(o=='xuehao'){
